var apiKey = '', currentTag, recrawl, 
    prefetchImg, queryString,
    displayedImages = 0;
var settingsQuery = '&format=json&nojsoncallback=1&safe_search=1&content_type=1&sort=interestingness-desc&extras=url_l&per_page=300',
    partialQueryTag = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=' + apiKey + settingsQuery,
    partialQueryGeneral = 'https://api.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=' + apiKey + settingsQuery;
